...
/**
 * Servlet implementation class AfficherNoteCC
 */
@WebServlet("/AfficherNoteCC")
public class AfficherNoteCC extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("AfficherNoteCC.jsp");
