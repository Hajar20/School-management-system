		 ...
		 <div class="container col-md-6" >
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<%=request.getContextPath()%>/updateProfilDirecteur" class="needs-validation"  method="POST"  novalidate>
                          <input type="hidden" name="id" value="<c:out value="${idDir}"/>" >
                          <input type="hidden" name="role" value="<c:out value="${roleE}"/>" >
