...
<meta charset="UTF-8">
<title>afficher modifier note</title>
</head>
       ...
       <%@ include file="nav2.jsp" %>
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4"> 
		     <div class="container">
                   ...
                   <form action="<%=request.getContextPath()%>/updateNoteCC" class="needs-validation" novalidate method="POST">
                    <table class="table table-bordered">
                        ...
                        <tbody id="myTable">
                        <c:forEach var="lNoteCC" items="${lNoteCC}">
                        <tr>
                            <td>
                              <c:out value="${lNoteCC.fullName}" />
                            </td>
                             <td>
                                  <input  name="<c:out value="${lNoteCC.fullName}"/>" value="<c:out value="${lNoteCC.note}"/>"  >
                    ...
                    <input type="hidden" name="idCC" value="<c:out value="${idCC}"/>" >
                     <input type="submit" class="btn btn-success" value="Modifier" style="width:30%">
