       ...
       <%@ include file="nav.jsp" %>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4"> 
         ...
         <br>
               <div class="row">
                <div class="container">
                    <h3 class="text-center">Les étudiants de <c:out value="${nameSp}" /> :</h3>
                    <hr>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="myTable">
                        <c:forEach var="students" items="${listEtds}">
                                <tr>
                                    <td>
                                      <c:out value="${students.nom }" />
                                    </td>
									
                                    <td>
                                      <c:out value="${students.prenom  }" />
                                    </td>
                                    
                                    <td>
                                      <c:out value="${students.matricule }" />
                                    </td>
