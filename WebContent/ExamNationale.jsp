      ...
      <div class="row">
       ...
       <%@ include file="nav.jsp" %>	
         ...
         <br>
               <div class="row">
                <div class="container">
                    <h3 class="text-center">Date d'examen national pour chaque année :</h3>
                    <hr>
                 
                    <div class="container text-left">
                        <a href="addExamNationalDate?nameE=National" class="btn btn-success">Ajouter la date de l'examen</a>  
                    </div>
                       ...
                       <tbody>
                        <c:forEach var="Exm" items="${listExm}">
                                <tr>
                                    ...
                                    <td>
                                    <a href="formulaireModifEx?idEx=<c:out value="${Exm.idEx}" />&nameE=National" class="btn btn-warning" >Modifier</a> 
                                    <a href="removeEx?idEx=<c:out value="${Exm.idEx}" />&nameE=National" class="btn btn-danger" >Supprimer</a> 
                                    </td>
                                </tr>
                         </c:forEach>
                        </tbody>
