		 ...
		 <div class="container col-md-6" >
                <div class="card">
                    <div class="card-body">
                      ...
                      <c:if test="${userE == null }">
                          <h3 >Ajouter nouvel enseignant</h3>
                      </c:if>
                      ...
                      <c:if test="${userE != null }">
						...
						<fieldset class="form-group">
                            <label>Le login (matricule@bts.com) :</label> <input type="email"  class="form-control" name="login" id="login" value="<c:out value="${userE.login }" />" required>
							<div class="invalid-feedback">
                             Login est invalide
                             </div>
                        </fieldset>
