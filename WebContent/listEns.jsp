      ...
      <div class="row">
       ...
       <%@ include file="nav.jsp" %>
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4"> 
		     <div class="container">
                    <h3 class="text-center">List des enseignants</h3>
                    <hr>
                    <div class="container text-left">

                        <a href="new?roleE=Enseignant" class="btn btn-success">Ajouter
                                nouvel enseignant</a>
                    </div>
                    <br>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="myTable">
                        <c:forEach var="utilisateur" items="${Ens}">
                        <tr>
                            <td>
                             ...
                             <td>
                              ...
                              <td>
                                  <c:out value="${utilisateur.matricule }"></c:out>    
                                    ...
                                    <td ><a href="modify?id=<c:out value="${utilisateur.idUser }" />&roleE=Enseignant" class="btn btn-warning" >Modifier</a> 
                                     <a href="delete?id=<c:out value="${utilisateur.idUser }" />&roleE=Enseignant" class="btn btn-danger">Supprimer </a> 
