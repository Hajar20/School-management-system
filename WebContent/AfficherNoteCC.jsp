                            ...
                            <td>
                             ...
                             <td>
                              ...
                              <td>
                               ...
                               <td>
                                <a href="AffModifNote?idClass=<c:out value="${lcc.idClasseCC}" />&idCC=<c:out value="${lcc.idCC}" />&filiere=<c:out value="${lcc.nomFCC}" />&anne=<c:out value="${lcc.annCC}" />&DateCC=<c:out value="${lcc.dateCC}" />&module=<c:out value="${lcc.nomModCC}" />" class="btn btn-warning">Afficher et modifier les notes</a>
								<a href="SuppNote?idCC=<c:out value="${lcc.idCC}" />&idCLasse=<c:out value="${lcc.idClasseCC}" />&idUser=<c:out value="${sessionScope.idUser}" />" class="btn btn-warning">Supprimer les notes</a>
