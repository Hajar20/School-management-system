		 ...
		 <div class="container col-md-6" >
		  <br><br>
                <div class="card">
                   ...
                   <c:if test="${Ex != null }">
                        <form action="<%=request.getContextPath()%>/updateExmN" class="needs-validation" novalidate method="POST">
                          <h2>Modifier la date de l'examen national :</h2> 
                          <input type="hidden" name="nameE" value="<c:out value="${nameE}"/>">
                           <input type="hidden" name="idEx" value="<c:out value="${idEx}"/>">
                      </c:if>
                      <c:if test="${Ex == null }">
                        <form action="<%=request.getContextPath()%>/insertExmN" class="needs-validation" novalidate method="POST">
                        <h2>Entrez la date de l'examen national :</h2>
                        <input type="hidden" name="nameE" value="<c:out value="${nameE}"/>">
                      </c:if>
						<br>
						<fieldset>
						<legend>
						 ...
						 <input type="date"  class="form-control" name="DateExN" value="<c:out value="${Ex.dateEx }" />" required>
